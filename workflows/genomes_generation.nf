...
workflow GGP {
    ...
    ch_versions = ch_versions.mix( PROCESS_INPUT.out.versions.first() )
    ...
    ch_versions = ch_versions.mix( QC_AND_MERGE_READS.out.versions.first() )
    ...
    ch_versions = ch_versions.mix( BINNING.out.versions.first() )
    ...
    if ( !params.skip_euk ) {
        ...
        ch_versions = ch_versions.mix( EUK_MAGS_GENERATION.out.versions.first() )
    }
    ...
    if ( !params.skip_prok ) {
        ...
        ch_versions = ch_versions.mix( PROK_MAGS_GENERATION.out.versions.first() )
    }
