...
STEPS = {
    'GGP:EUK_MAGS_GENERATION:EUKCC_MERGE_CONCOCT:EUKCC': 0,
    'GGP:EUK_MAGS_GENERATION:EUKCC_MERGE_METABAT:EUKCC': 1,
    'GGP:EUK_MAGS_GENERATION:FILTER_QUALITY': 2,
    'GGP:EUK_MAGS_GENERATION:DREP_DEREPLICATE_RUNS': 3,
    'GGP:EUK_MAGS_GENERATION:DREP_DEREPLICATE_MAGS': 4,
    'GGP:PROK_MAGS_GENERATION:BINETTE': 5,
    'GGP:PROK_MAGS_GENERATION:CHECKM2': 6,
    'GGP:PROK_MAGS_GENERATION:FILTER_QUALITY': 7,
    'GGP:PROK_MAGS_GENERATION:DREP_DEREPLICATE': 8
}
