...
STEPS = {
    'GGP:EUK_MAGS_GENERATION:EUKCC_CONCOCT': 0,
     ...
     'GGP:EUK_MAGS_GENERATION:FILTER_QS50': 2,
     ...
     'GGP:PROK_MAGS_GENERATION:BIN_REFINEMENT:CONSOLIDATE_BINS': 13,
     'GGP:PROK_MAGS_GENERATION:CHECKM2': 14,
     'GGP:PROK_MAGS_GENERATION:DREP': 15
}
