...
# FIXME: Fix EukCC bioconda package
# This scripts belongs to EukCC, but the current bioconda package doesn't provide all the dependnecies (biopython and pysam)
# Script version: https://raw.githubusercontent.com/EBI-Metagenomics/EukCC/v.2.1.1/scripts/binlinks.py
