...
singularity pull --name quay.io_microbiome-informatics.python3_scripts:v1.sif \
...
singularity pull --name quay.io_microbiome-informatics.eukrecover_minimap2.sh:v2.sif \
