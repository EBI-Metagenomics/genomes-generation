...
2) Download data from ENA, [rename](download_data/scripts/rename-erz.py) assembly files and [generate](download_data/scripts/generate_samplesheet.py) input samplesheet:
```commandline
