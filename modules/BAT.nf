process EUK_TAXONOMY {
    ...
    CAT add_names -i ${bin.baseName}.BAT_run.ORF2LCA.txt -o ${bin.baseName}.BAT_run.ORF2LCA.names.txt -t ${taxonomy_db}

    echo "[MAG euk taxonomy] Summarizing output"
    CAT summarise -i ${bin.baseName}.BAT_run.ORF2LCA.names.txt -o ${bin.baseName}.summary.txt
